...
async def on_bot_membership_changed(event: types.ChatMemberUpdated):
    ...
    if just_joined and not is_admin:
        # ⚠️ Ҳали администратор эмасмиз. Гуруҳга хабар юборишга уринмаймиз —
        # кўп гуруҳда бу барибир "chat_admin_required" билан рад этилади ва
        # ҳеч ким сабабини билмай қоларди. Ўрнига қўшган одамга шахсан
        # ёзамиз, админ ҳуқуқи берилиши биланоқ (қуйидаги just_promoted
        # тармоғи) созлашни ўзимиз бошлаймиз.
...
async def _ask_for_admin_rights(event: types.ChatMemberUpdated):
    """Ботни қўшган одамга: админ ҳуқуқи берилса, созлаш ўзи бошланади."""
    try:
