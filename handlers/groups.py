...
async def _ask_for_admin_rights(event: types.ChatMemberUpdated):
    ...
    try:
        await bot.send_message(
            ...
            text=(
                f"👋 Мени «{html.escape(event.chat.title or '')}» гуруҳига "
                f"қўшганингиз учун раҳмат!\n\n"
                f"⚠️ Ишни бошлашим учун менга шу гуруҳда "
                f"<b>администратор</b> ҳуқуқи керак (камида "
                f"«Хабар юбориш» рухсати билан).\n\n"
                f"✅ Ҳуқуқ берганингиздан кейин мен гуруҳга ўзим ёзаман "
                f"ва қайси вилоят(лар)га боғлашни сўрайман — бошқа ҳеч "
                f"нарса қилишингиз шарт эмас."
            ),
            parse_mode="HTML"
        )
    except Exception as e:
