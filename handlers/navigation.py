...
async def help_cmd(message: types.Message):
    ...
    await message.answer(
        "🐾 <b>ЧОРВА БОЗОР БОТИ — ЙЎРИҚНОМА</b> 🐾\n"
        "━━━━━━━━━━━━━━━━━━━━━\n\n"
        "Ассалому алайкум! Мен чорва мол-ҳол эълонлари бўйича "
        "ёрдамчи ботман. Қуйида ҳар бир тугма нима қилишини топасиз 👇\n\n"

        "➕ <b>Эълон бериш</b>\n"
        "Ҳайвонингизни (сигир, қўй, эчки, от ва ҳ.к.) саволлар орқали "
        "қадам-бақадам эълон қиласиз — расм/видео, нарх, манзил, телефон.\n\n"

        "📱 <b>Эълон (тезкор форма)</b>\n"
        "Пастдаги хабар қутиси ёнидаги <b>«Эълон»</b> тугмасини босиб, "
        "бир саҳифада ҳаммасини тезроқ тўлдирасиз. ⚡️\n\n"

        "🔍 <b>Эълон қидириш</b>\n"
        "Ҳайвон тури, вилоят, туман ва нарх бўйича фильтрлаб, мавжуд "
        "эълонларни кўрасиз.\n\n"

        "📊 <b>Бозор таҳлили</b>\n"
        "• 📈 Нархлар индекси — қайси вилоятда қанча нархда сотилаётганини "
        "кўрасиз;\n"
        "• 🧮 Ферма калькулятори — қўй/қорамол боқиш харажатларини "
        "ҳисоблайсиз.\n\n"

        "🗂 <b>Менинг эълонларим</b>\n"
        "Ўзингиз жойлаган актив эълонларни бошқарасиз: 🤝 сотилди деб "
        "белгилаш, 🗑 ўчириш ёки ⏳ муддати тугаётганда 🔄 қайта жойлаш "
        "(Премиум учун).\n\n"

        "🩺 <b>Ветеринария</b>\n"
        "Вилоят/туман бўйича веб ветеринария ходимларининг алоқа "
        "маълумотларини топасиз.\n\n"

        "🔔 <b>Хабардор қил</b>\n"
        "Ўзингизга қизиқ мезонларни (ҳайвон тури, вилоят, нарх оралиғи) "
        "созлаб қўйинг — шунга мос эълон пайдо бўлса, бот дарҳол "
        "хабар беради. 🔕\n\n"

        "━━━━━━━━━━━━━━━━━━━━━\n"
        "⚠️ <b>Диққат:</b> ҳар бир эълон каналга/гуруҳларга жойланишидан "
        "олдин админ томонидан кўриб чиқилади — шунинг учун бироз "
        "кутиш керак бўлиши мумкин. ⏳\n\n"

        "❓ Муаммо ёки таклиф бўлса — админга ёзинг.\n"
        "🔁 Ушбу йўриқномани қайта кўриш учун: /help",
        parse_mode="HTML",
        reply_markup=kb
    )
